        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Titel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErstellerId = table.Column<string>(type: "text", nullable: false),
                    ErstelltAm = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ZugewiesenerBenutzerId = table.Column<string>(type: "text", nullable: true),
                    ZugewiesenAm = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GeschlossenVonId = table.Column<string>(type: "text", nullable: true),
                    GeschlossenAm = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Inhalt = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    TicketId = table.Column<int>(type: "integer", nullable: false),
                    ErstellerId = table.Column<string>(type: "text", nullable: false),
                    Erstellzeitpunkt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlockiertesTicketId = table.Column<int>(type: "integer", nullable: false),
                    BlockierendesTicketId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
